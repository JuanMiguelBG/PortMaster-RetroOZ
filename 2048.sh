...
PORT_LOG_FILE="/roms/logs/2048.log"

echo "2048: " | tee $PORT_LOG_FILE
...
echo "Launch command: $raloc/retroarch $raconf -L $GAMEDIR/2048_libretro.so 2>&1 | tee -a $PORT_LOG_FILE" | tee -a $PORT_LOG_FILE
$raloc/retroarch $raconf -L $GAMEDIR/2048_libretro.so 2>&1 | tee -a $PORT_LOG_FILE
